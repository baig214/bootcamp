...
var updateButtonText = () =>{
    ...
    button.textContent = `${goal%2 === 1 ? team1.name:team2.name} Strike`;
};
...
var updateRuns = () =>{
    ...
    team1.runs.forEach((run,index)=>{
        run === 1 ? teamOneRunsElement[index].style.backgroundColor = "#effad3" :teamOneRunsElement[index].style.backgroundColor = "#d00c0c";
    });
    team2.runs.forEach((run,index)=>{
        run === 1 ? teamTwoRunsElement[index].style.backgroundColor = "#a8dda8" : teamTwoRunsElement[index].style.backgroundColor = "#d00c0c";
